                ...
                <div class="layui-col-md9" style="left: 250px">
                    <div class="grid-demo grid-demo-bg2">
                        ...
                        <div class="ui-dialog-content">
                            ...
                            <div class="ui-dialog-l40 ui-dialog-pt15" style="margin-top: 380px;margin-left: 110px">
                                <input class="ui-dialog-input ui-dialog-input-code" style="margin-right: 120px;margin-top: -380px" type="input"  placeholder="验证码" />
                                <a class="ui-dialog-submit" style="margin-top: -340px;size: 30px;width: 150px;margin-left: 170px" href="${ctx}/home/index">获取验证码</a>
                            </div>
                            <div>
                                <a class="ui-dialog-submit" style="margin-top: -310px;size: 90px;width: 250px;margin-left: 180px" href="${ctx}/home/index">登录</a>
                            </div>
                            <br>
                            <div class="login">
                                <font face="楷体" href="${ctx}/home/consumer" color="gray" style="margin-left: 40px" >点击浏览→<a href="${ctx}/home/consumer" style="color: black">全城家居建材市场</a></font>
                            </div>
                        </div>
                    </div>
                </div>
